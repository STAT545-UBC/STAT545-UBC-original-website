...
Extend the above three types of documentation.
...
__Note__: Here's an example of the benefits of not having your functions to too much -- I only needed to change `pow` alone to get the changes to work for `square` and `cube`. 
