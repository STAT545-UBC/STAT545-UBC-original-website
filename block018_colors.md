...
Because of the way figures are handled by `knitr`, it is more complicated to change the default plotting symbol throughout, e.g., an R Markdown document. To see how I've done it, check out a hidden chunk around here in the [source of this page FIX THIS!](https://github.com/STAT545-UBC/STAT545-UBC.github.io).
...
TO DO: FIX THESE INTERNAL LINKS!
...
TO DO: BRING THIS FIGURE INTO THIS REPO
