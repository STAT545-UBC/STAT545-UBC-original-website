...
Make these edits:
  ...
  * Add a `URL` for more information (optional) and add a link to the reposity for `BugReports`.
...
DESCRIPTION_fodder <- c(
  ...
  "BugReports: https://github.com/STAT545-UBC/STAT545-UBC.github.io",
...
file.copy(file.path(owd, "packages06_foofactors-vignette.Rmd"),
...
file.copy(file.path(owd, "packages06_foofactors-README.Rmd"),
